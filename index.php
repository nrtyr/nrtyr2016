			...
			<!-- Header -->
				<header id="header">
					<div class="logo container">
						<div>
							<h1><a href="index.php" id="logo">H. Ayuntamiento de Nicolás Romero</a></h1>
							<p>2016 - 2018</p>
						</div>
					</div>
				</header>
															...
															<ul class="divided">
																...
																<li>
																	<article class="box post-summary">
																		<h3><a href="#">Artículo</a></h3>
																		<ul class="meta">
																			<li class="icon fa-clock-o">hace 20 horas</li>
																			<li class="icon fa-comments"><a href="#">27</a></li>
																		</ul>
																	</article>
																</li>
																<li>
																	<article class="box post-summary">
																		<h3><a href="#">Artículo</a></h3>
																		<ul class="meta">
																			<li class="icon fa-clock-o">hace 1 Día</li>
																			<li class="icon fa-comments"><a href="#">27</a></li>
																		</ul>
																	</article>
																</li>
																<li>
																	<article class="box post-summary">
																		<h3><a href="#">Artículo</a></h3>
																		<ul class="meta">
																			<li class="icon fa-clock-o">hace 1 semana</li>
																			<li class="icon fa-comments"><a href="#">27</a></li>
																		</ul>
																	</article>
																</li>
